...
import bitmap_listen from '../assets/Bitmap12.png'
import bitmap_phone from '../assets/Bitmap_13.png'
import bitmap_4 from '../assets/Bitmap_11.png'
        ...
        <>
            <div className="w-[1440px] mx-auto">
                <div className="mx-auto flex flex-col  px-[165px] mb-24 mt-40">
                    <Link className="text-[15px]" to='/earphones'>Go Back</Link>
...
export default EarPhonesDetailOne
