...
import bitmap_listen from '../assets/Bitmap-5.png'
import { data_add } from "../redux/dataBaseSlice";
import bitmap_phone from '../assets/Bitmap-6.png'
import bitmap_4 from '../assets/Bitmap_4.png'
                        ...
                        <div className="flex justify-between">
                            <div className="w-[350px] mt-24">
                                <div className="bg-[#F1F1F1] w-[350px] h-[318px] flex justify-center items-center">
                                    <img className="w-[148.38px] h-[193px]" src={zx70} alt="" />
                                </div>
                                <h4 className="text-[24px] flex justify-center my-12">ZX7 SPEAKER</h4>
                                <h4 className="flex justify-center items-center"><Link to='/speakers/speaker-2' className='text-white px-12 py-4 rounded-lg bg-[#D87D4A] hover:bg-[#FBAF85] transition duration-200   w-[160px] text-center text-[12px]  uppercase'>See Product</Link></h4>
...
export default SpeakersDetailOne
