...
import bitmap_listen from '../assets/Bitmap_listen_3.png'
import bitmap_phone from '../assets/Bitmap_phone_3.png'
import bitmap_bluteth from '../assets/Bitmap_bluteth_black.png'
        ...
        <>
            <div className="w-[1440px] mx-auto">
                <div className="mx-auto flex flex-col  px-[165px] mb-24 mt-40">
                    ...
                    <Card image1={bitmap_listen} image2={bitmap_phone} image3={bitmap_bluteth}></Card>
                        ...
                        <div className="flex justify-between">
                            <div className="w-[350px] mt-24">
                                <div className="bg-[#F1F1F1] w-[350px] h-[318px] flex justify-center items-center">
                                    <img className="w-[148.38px] h-[193px]" src={EARPHONES__img_D} alt="" />
                                </div>
                                <h4 className="text-[24px] flex justify-center my-12">XX99 MARK II</h4>
                                <h4 className="flex justify-center items-center"><Link to='/headphones/headpones-1' className='text-white px-12 py-4 rounded-lg bg-[#D87D4A] hover:bg-[#FBAF85] transition duration-200   w-[160px] text-center text-[12px]  uppercase'>See Product</Link></h4>
...
export default HeadPhonesdetailTwo
